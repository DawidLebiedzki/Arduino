#ifndef _ADAFRUIT_GFX_AS8_H
#define _ADAFRUIT_GFX_AS8_H
...
class Adafruit_GFX_AS8 : public Print {

 public:

  Adafruit_GFX_AS8(int16_t w, int16_t h); // Constructor
  ...
  // These exist only with Adafruit_GFX_AS8 (no subclass overrides)
  void
